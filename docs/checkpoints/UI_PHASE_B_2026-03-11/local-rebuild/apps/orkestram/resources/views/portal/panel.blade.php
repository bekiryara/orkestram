...
@section('content')
    @php($roleLabels = ['customer' => 'Musteri', 'listing_owner' => 'Ilan Sahibi', 'support_agent' => 'Destek', 'admin' => 'Admin', 'super_admin' => 'Super Admin', 'content_editor' => 'Icerik Editoru', 'listing_editor' => 'Ilan Editoru', 'viewer' => 'Goruntuleyici'])
