...
1. `TASK-093` - simple pricing v1 pricing_mode ve publish guard tamamlandi
2. `TASK-092` - simple pricing v1 validation ve ui sadelestirme tamamlandi
3. `TASK-091` - 085-090 merge treni ana hatta tasindi
## Son Kapanis
1. `TASK-093` - simple pricing v1 pricing_mode ve publish guard tamamlandi
2. `TASK-092` - simple pricing v1 validation ve ui sadelestirme tamamlandi
3. `TASK-091` - 085-090 merge treni ana hatta tasindi
